...
?> **팁**: 비상 접근 IP는 tkadmin 내/외부 설정 메뉴에서 관리할 수 있습니다. 자세한 내용은 [내/외부 설정 편집기](../3-features/02-config-editor.md)를 참조하세요.
...
- [대시보드](../3-features/01-dashboard.md): 시스템 상태 모니터링 화면을 확인하세요.
- [내/외부 설정 편집기](../3-features/02-config-editor.md): 주요 설정 항목을 관리하는 방법을 배우세요.

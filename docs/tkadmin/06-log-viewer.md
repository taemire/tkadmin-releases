...
<!-- 스크린샷: 시스템 로그 전체 화면 -->
![시스템 로그 화면](../../assets/images/user/06_log_viewer_overview.png)
...
<!-- 스크린샷: 검색어 하이라이팅 예시 -->
![검색어 하이라이팅](../../assets/images/user/06_log_viewer_highlight.png)
...
<!-- 스크린샷: 로그 상세 데이터 확장 -->
![로그 상세 데이터](../../assets/images/user/06_log_viewer_detail.png)
